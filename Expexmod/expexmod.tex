...
% glottophilos-jon 2022/10/25 (unofficial version)
%   updated to allow for verse numbering in nlevel glosses
% glottophilos-jon 2023/1/30 (unofficial version)
%   updated to add more arguments available for verse numbering
% --------------------------------------------------------
...
\def\gln@ilg@h #1{% 
   \gln@printglword
   \ifx\useverse\checked
        \verseup
    \else \ifx\useverse\checkplus \versepp
    \else \ifx\useverse\resetcheck \resetverse
    \else \relax \fi\fi\fi
   \ifx\@diacritic\empty
